...
class BaseUNet(nn.Module):
    ...
    def build_encoders(self):
        ...
        for i, (input_size, output_size) in enumerate(zip(self.encoder_input_sizes, self.encoder_output_sizes)):
            ...
            encoders.append(
                self.ff_type( #ff_type is a convolution layer
                    input_size,
                    output_size,
    ...
    def build_prediction_layer(self):
        return self.ff_type(
            in_channels=2 * self.base_channels if self.skip_type == "concat" else self.base_channels,
    ...
    # TODO modify this part to predict a segmentation mask
    # self.num_output_channels = 1 for dynamic mask
    # self.num_output_channels = 2 for optical flow
