...
from dynamic_masker.unuseful.mlflow import log_config, log_results
...
def test(args, config_parser):
    ...
    mlflow.set_tracking_uri("/home/rpg/Desktop/taming_event_flow/mlruns")

    run = mlflow.get_run("42")
