...
Example -> CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 TrainHermNoAtten.py --master_port=29514
"""
...
class TrainHermNoAtten(TrainHerm):
    """
    A training class for the 'Herm' configuration without attention, modified for multi-GPU training.
    ...
    def init_model_name(self):
        ...
        if self.checkpoint_path:
            ...
            return "HermNoAtten_" + datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
    ...
    def build_model(self):
        """
        MODIFIED: Wraps the model with DDP for distributed training.
        """
...
if __name__ == "__main__":
    ...
    herm_trainer = TrainHermNoAtten(
        config_path="dynamic_masker/configs/train_herm_no_atten.json", 
        checkpoint_path="",
